...
const NavBar = () => {
    ...
    return (
        <div className='flex justify-between items-center w-full h-20 px-4 text-white bg-gradient-to-b from-gray-600 to-black'>
            <div className='flex flex-row gap-1'>
                <h3 className='text-4xl font-itim ml-4'>MyPortfolio</h3>
            </div>
